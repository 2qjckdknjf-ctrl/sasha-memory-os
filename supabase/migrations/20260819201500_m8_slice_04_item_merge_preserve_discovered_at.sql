...
BEGIN
  ...
  v_existing_discovered := coalesce(v_collections->'discovered_at', 'null'::jsonb);
  v_discovered := coalesce(to_jsonb(p_discovered_at), v_existing_discovered, 'null'::jsonb);
