...
4. ~~M5 retrieval polish~~ — RRF hybrid + authority + context packer + temporal search (alpha)  
5. ~~Apply remote `search_rrf_temporal`~~ — applied 2026-08-12 (SQL editor + schema_migrations)  
6. M6 ChatGPT remote A — pilot profile + Streamable HTTP + tunnel script ready; register in ChatGPT Developer mode when HTTPS URL live  
